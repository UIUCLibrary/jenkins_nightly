pipeline {
    ...
    parameters {
      ...
      booleanParam defaultValue: false, description: 'Run nightly build for HathiZip',                  name: "BUILD_HathiZip"
      booleanParam defaultValue: false, description: 'Run nightly build for pyhathiprep',               name: "BUILD_pyhathiprep"
      booleanParam defaultValue: false, description: 'Run nightly build for HT_checksum_update',        name: "BUILD_HT_checksum_update"
      booleanParam defaultValue: false, description: 'Run nightly build for uiucprescon.images',        name: "BUILD_uiucprescon_images"
      booleanParam defaultValue: false, description: 'Run nightly build for uiucprescon.packager',      name: "BUILD_uiucprescon_packager"
      booleanParam defaultValue: false, description: 'Run nightly build for uiucprescon.imagevalidate', name: "BUILD_uiucprescon_imagevalidate"
      booleanParam defaultValue: false, description: 'Run nightly build for pyexiv2bind2',              name: "BUILD_pyexiv2bind2"
      booleanParam defaultValue: false, description: 'Run nightly build for DCCMedusaPackager',         name: "BUILD_DCCMedusaPackager"
      booleanParam defaultValue: false, description: 'Run nightly build for HathiValidate',             name: "BUILD_HathiValidate"
      booleanParam defaultValue: false, description: 'Run nightly build for PackageValidation',         name: "BUILD_PackageValidation"
      booleanParam defaultValue: false, description: 'Run nightly build for speedwagon',                name: "BUILD_speedwagon"
    }
    stages{
